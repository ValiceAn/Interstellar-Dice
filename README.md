...
## Goal
Get the highest score by making combinations with 5 dice.

## Turns
- Each player can roll up to 3 times per turn.
...
- Once closed, that number cannot be used again.

## Penalties
- -5 points for any empty single/"school" spot.
